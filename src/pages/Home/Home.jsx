                ...
                <div className="md:container">
                    <div className="flex justify-between">
                        <div className="logo flex p-4 gap-2 ">
                            ...
                            <div className="text-3xl text-[#38BBBC] font-semibold">TodoList</div>
                        </div>
                        <div className="menubar flex gap-6 justify-center align-middle p-4 text-2xl text-violet-900 hover:text-[#38BBBC] cursor-pointer">
                            <Link to="/">Home</Link>
                            <div>Features</div>
                            <div>TaskList</div>
                            <div className="pl-20">
                                <button className="rounded-xl bg-[#38BBBC] px-4 py-3 text-white text-lg text-center">Add Your Task</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 place-content-between">
                        <div className="flex flex-col justify-center items-center">
                            ...
                            <div className="flex items-center justify-center mt-10">
                                ...
                                <Link to ="/tasklist" class="relative inline-block text-lg group">
